...
namespace Hotel_Management_System.GUI
{
    public partial class FormSuaTienNghi : Form
    {
        ...
        //Event Methods
        private void FormSuaTienNghi_Paint(object sender, PaintEventArgs e)
        {
            //-> SMOOTH OUTER BORDER
        ...
        private void FormSuaTienNghi_Resize(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void FormSuaTienNghi_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void FormSuaTienNghi_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
