    ...
    public partial class FormDatPhong : Form
    {
        ...
        private void FormDatPhong_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                grid1.ColumnHeadersDefaultCellStyle.WrapMode = DataGridViewTriState.False;
                grid2.ColumnHeadersDefaultCellStyle.WrapMode = DataGridViewTriState.False;
                LoadgridPhongTrong();
                LoadGridPhongDat();
                setLoadComboBox();
                LoadTimeItems();
        ...
        private void CTButtonDatTruoc_Click(object sender, EventArgs e)
        {
            ...
            if (this.CTTextBoxNhapCCCD.Texts != "" && this.CTTextBoxNhapDiaChi.Texts != "" && this.CTTextBoxNhapHoTen.Texts != "" && this.ComboBoxGioiTinh.Texts != "  Giới tính")
            {
                ...
                if (this.Owner is FormSoDoPhong parent)
                {
                    try
                    {
                        parent.LoadLanDau();
