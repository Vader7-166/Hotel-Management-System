...
namespace Hotel_Management_System.CustomControl
{
    ...
    public partial class CTComboBox : UserControl
    {
        ...
        private void Icon_Paint(object sender, PaintEventArgs e)
        {
            ...
            int iconWidht = 10;
            int iconHeight = 4;
            var rectIcon = new Rectangle((btnIcon.Width - iconWidht+10) / 2, (btnIcon.Height - iconHeight) / 2, iconWidht, iconHeight);
